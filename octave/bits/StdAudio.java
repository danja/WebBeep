/**
from http://introcs.cs.princeton.edu/java/stdlib/StdAudio.java.html
 * 
 */
...
public final class StdAudio {
    ...
    ***********************************************************************/
    ...
    public static void main(String[] args) {
    	...
    	double data[] = new double[StdAudio.SAMPLE_RATE];
    	
        // 440 Hz for 1 sec
        double freq = 440.0;
        for (int i = 0; i < StdAudio.SAMPLE_RATE; i++) {
        //    StdAudio.play(0.5 * Math.sin(2*Math.PI * freq * i / StdAudio.SAMPLE_RATE));
            data[i] = 0.5 * Math.sin(2*Math.PI * freq * i / StdAudio.SAMPLE_RATE);
        }
...
System.out.println("saving");
        ...
        save("/home/danny/workspace/UTone/data/beep.wav", data); 
