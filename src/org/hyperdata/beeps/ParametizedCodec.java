 ...
 * 
 */
public class ParametizedCodec { // somehow pass this parameters

	public ParametizedCodec() {
	}
	...
	public double getFitness() { 
		...
		// System.out.println("Average encode time = "+Plotter.roundToSignificantFigures((float)encodeTimeSum/(1000*runs),
		// 2)+" seconds");
		// System.out.println("Average decode time = "+Plotter.roundToSignificantFigures((float)decodeTimeSum/(1000*runs),
		// 2)+" seconds");
		// System.out.println("Average total time = "+Plotter.roundToSignificantFigures(((float)encodeTimeSum+decodeTimeSum)/(1000*runs),
		// 2)+" seconds");
		// System.out.println("Mean encode time for 100% transfer = "+Plotter.roundToSignificantFigures((float)encodeHitTimeSum/(1000*successCount),
		// 2)+" seconds");
		// System.out.println("Mean decode time for 100% transfer = "+Plotter.roundToSignificantFigures((float)decodeHitTimeSum/(1000*successCount),
		// 2)+" seconds");

		long time = (encodeTime + decodeTime)/1000;
